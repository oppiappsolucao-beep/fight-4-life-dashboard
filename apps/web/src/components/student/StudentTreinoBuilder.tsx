    ...
    <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {phaseCatalog.map((exercise) => (
              ...
              >
                ...
                <button
                  ...
                  className="shrink-0 rounded-lg bg-[#5B7595]/20 px-3 py-1.5 text-xs font-semibold text-[#A9BBD5]"
                >
                  +
                </button>
              </div>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button
          ...
          className="flex-1 rounded-xl bg-[#5B7595] px-4 py-3 text-sm font-semibold text-white disabled:opacity-60"
        >
