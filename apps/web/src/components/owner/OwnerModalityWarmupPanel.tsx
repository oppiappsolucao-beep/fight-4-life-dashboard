      ...
      <div className="mt-3 max-h-48 space-y-2 overflow-y-auto">
        {filteredCatalog.map((exercise) => (
          <button
            ...
            className="flex w-full items-center justify-between rounded-lg border border-white/10 bg-black/15 px-3 py-2 text-left text-sm text-white/80 hover:border-[#5B7595]/40"
          >
