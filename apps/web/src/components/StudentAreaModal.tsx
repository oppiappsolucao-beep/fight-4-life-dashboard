      ...
      >
        ...
        <form onSubmit={handleSubmit} className="px-6 pb-6">
          <div className="mb-5 flex justify-center">
            <div className="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-[#2E496C] to-[#5B7595] px-4 py-2 text-white">
              <MailIcon />
          ...
          <input
            ...
            className="mb-2 w-full rounded-lg border border-white/20 bg-white px-3 py-2.5 text-[0.82rem] text-black outline-none transition focus:border-[#5B7595]/60 focus:ring-2 focus:ring-[#5B7595]/15"
          />
          ...
          <div className="mt-6 flex justify-end">
            <button
              type="submit"
              className="rounded-lg bg-gradient-to-r from-[#2E496C] to-[#5B7595] px-6 py-2.5 text-[0.75rem] font-bold uppercase tracking-wide text-white transition hover:brightness-105"
            >
              Continuar
            </button>
          </div>
